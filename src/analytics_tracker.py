...
and generates a state-of-the-art dual-hub portal for GitHub Pages:
  1. 🌟 Public Investor & Copier Hub:
     ...
     • Interactive Performance Comparison vs Benchmarks (SPX500, MSCI World, EuroStoxx50, China50)
     • Interactive Asset Allocation & Sector Doughnut Charts
     • Interactive Portfolio Holdings Explorer (all 41 stocks & ETFs with logos, search, filters)
...
HOLDINGS_DATA = [
    ...
    {"ticker": "NVDA", "name": "NVIDIA Corporation", "emoji": "🤖", "sector": "AI & Semiconduttori", "geo": "USA", "tier": "Core Growth", "desc": "Leader mondiale indiscusso nei chip per intelligenza artificiale e calcolo accelerato."},
    {"ticker": "MSFT", "name": "Microsoft Corporation", "emoji": "💻", "sector": "Software & Cloud AI", "geo": "USA", "tier": "Core Holding", "desc": "Gigante del cloud (Azure), enterprise software e partnership strategica con OpenAI."},
    {"ticker": "AMZN", "name": "Amazon.com Inc", "emoji": "📦", "sector": "E-Commerce & Cloud AWS", "geo": "USA", "tier": "Core Holding", "desc": "Leader globale dell'e-commerce, dell'infrastruttura cloud AWS e advertising digitale."},
    {"ticker": "GOOG", "name": "Alphabet Inc (Google)", "emoji": "🔍", "sector": "Search, Cloud & AI", "geo": "USA", "tier": "Core Holding", "desc": "Monopolio dei motori di ricerca, YouTube, ecosistema Android e modelli Google Gemini."},
    {"ticker": "PLTR", "name": "Palantir Technologies", "emoji": "🛡️", "sector": "AI Governativa & Difesa", "geo": "USA", "tier": "High Growth", "desc": "Piattaforme AIP per analisi dati mission-critical nella difesa, intelligence e grandi corporate."},
    {"ticker": "AVGO", "name": "Broadcom Inc", "emoji": "🔌", "sector": "Semiconduttori & Networking", "geo": "USA", "tier": "Core Growth", "desc": "Componenti di rete ad alta velocità per data center AI e software VMware enterprise."},
    {"ticker": "TSM", "name": "Taiwan Semiconductor", "emoji": "🏭", "sector": "Fonderie Chip Globali", "geo": "Asia", "tier": "Core Holding", "desc": "La più avanzata fonderia di chip al mondo, fornitore chiave di Apple, NVIDIA e AMD."},
    {"ticker": "MRVL", "name": "Marvell Technology", "emoji": "📊", "sector": "Chip Custom & Reti Ottiche", "geo": "USA", "tier": "Growth", "desc": "Chip ASIC personalizzati per hyperscaler cloud e interconnessioni elettro-ottiche ultraveloci."},
    {"ticker": "NET", "name": "Cloudflare Inc", "emoji": "☁️", "sector": "Cloud Security & CDN", "geo": "USA", "tier": "Growth", "desc": "Rete globale edge security, protezione DDoS e infrastruttura internet ad altissima affidabilità."},
    {"ticker": "PYPL", "name": "PayPal Holdings", "emoji": "💳", "sector": "Pagamenti Digitali & Fintech", "geo": "USA", "tier": "Value Turnaround", "desc": "Pioniere dei pagamenti online globali, brand Venmo e innovazione nei checkout one-click."},

    # ── Healthcare & GLP-1 Megatrend ──────────────────────────────────────────
    {"ticker": "LLY", "name": "Eli Lilly and Co", "emoji": "💊", "sector": "Farmaceutica & GLP-1", "geo": "USA", "tier": "Core Growth", "desc": "Leader mondiale nei farmaci antidiabete e obesità (Mounjaro, Zepbound) e oncologia avanzata."},
    {"ticker": "NOVO-B.CO", "name": "Novo Nordisk A/S", "emoji": "💉", "sector": "Farmaceutica & GLP-1", "geo": "Europa", "tier": "Core Growth", "desc": "Pioniere danese nei trattamenti GLP-1 (Ozempic, Wegovy) per salute metabolica globale."},
    {"ticker": "ABBV", "name": "AbbVie Inc", "emoji": "💉", "sector": "Biotech & Immunologia", "geo": "USA", "tier": "Dividend Aristocrat", "desc": "Pipeline innovativa in oncologia, immunologia (Skyrizi, Rinvoq) e dividendo storico in crescita."},
    {"ticker": "ABT.US", "name": "Abbott Laboratories", "emoji": "🏥", "sector": "Dispositivi Medici & Diagnostica", "geo": "USA", "tier": "Core Defensive", "desc": "Dispositivi medici essenziali (FreeStyle Libre per glucosio) e nutrizione clinica mondiale."},
    {"ticker": "HUM", "name": "Humana Inc", "emoji": "🏥", "sector": "Assicurazione Sanitaria USA", "geo": "USA", "tier": "Value / Healthcare", "desc": "Specialista leader nei piani sanitari Medicare Advantage per la popolazione senior USA."},
    {"ticker": "AZN.L", "name": "AstraZeneca PLC", "emoji": "🧬", "sector": "Oncologia & Biofarmaci", "geo": "Europa", "tier": "Core Growth", "desc": "Colosso biofarmaceutico anglo-svedese con leadershipTabella in terapie oncologiche mirate."},

    # ── Energy, Utilities, Commodities & Nuclear ──────────────────────────────
    {"ticker": "CCJ", "name": "Cameco Corporation", "emoji": "⚡", "sector": "Uranio & Nucleare Pulito", "geo": "USA / Canada", "tier": "Megatrend Nucleare", "desc": "Il più grande produttore occidentale di uranio per la rinascita dell'energia nucleare e data center AI."},
    {"ticker": "ENEL.MI", "name": "Enel S.p.A.", "emoji": "🔋", "sector": "Utility & Energia Rinnovabile", "geo": "Europa", "tier": "High Dividend", "desc": "Leader europeo nelle reti elettriche intelligenti, generazione green e alto flusso cedolare."},
    {"ticker": "ENI.MI", "name": "Eni S.p.A.", "emoji": "⛽", "sector": "Energia & Biocarburanti", "geo": "Europa", "tier": "High Dividend", "desc": "Major integrata con forte cash flow, transizione energetica con Plenitude ed Enilive."},
    {"ticker": "PRY.MI", "name": "Prysmian S.p.A.", "emoji": "🔌", "sector": "Cavi Elettrici & Telecom", "geo": "Europa", "tier": "Industrial Leader", "desc": "Numero uno mondiale nei cavi sottomarini per l'elettrificazione e trasmissione rinnovabili."},
    {"ticker": "GLEN.L", "name": "Glencore PLC", "emoji": "⛏️", "sector": "Metalli per la Transizione", "geo": "Europa", "tier": "Commodities", "desc": "Estrazione e trading globale di rame, cobalto e nichel essenziali per batterie ed elettrificazione."},
    {"ticker": "TRIG.L", "name": "Renewables Infrastructure Grp", "emoji": "🌬️", "sector": "Infrastrutture Eoliche/Solari", "geo": "Europa", "tier": "High Yield Green", "desc": "Fondo infrastrutturale UK con portafoglio diversificato di impianti eolici e solari europei."},
    {"ticker": "MAU.PA", "name": "Maurel & Prom SA", "emoji": "🛢️", "sector": "Esplorazione & Produzione", "geo": "Europa", "tier": "Tactical Energy", "desc": "Compagnia petrolifera francese a dividendo elevato e basso indebitamento."},

    # ── Consumer, Retail & Luxury ─────────────────────────────────────────────
    {"ticker": "WMT", "name": "Walmart Inc", "emoji": "🛒", "sector": "Grande Distribuzione & Retail", "geo": "USA", "tier": "Core Defensive", "desc": "Il re del retail globale con espansione massiccia nell'e-commerce, logistica autonoma e ads."},
    {"ticker": "MELI", "name": "MercadoLibre Inc", "emoji": "🛒", "sector": "E-Commerce & Fintech LatAm", "geo": "Emergenti", "tier": "High Growth", "desc": "La 'Amazon + PayPal' dell'America Latina con tassi di crescita eccezionali in Brasile e Messico."},
    {"ticker": "RACE", "name": "Ferrari N.V.", "emoji": "🏎️", "sector": "Lusso & Motorsport", "geo": "Europa", "tier": "Ultra-Luxury Moat", "desc": "Margini operativi record, portafoglio ordini blindato e potere di prezzo assoluto nel lusso mondiale."},
    {"ticker": "VOW3.DE", "name": "Volkswagen AG", "emoji": "🚗", "sector": "Automotive & Mobilità EV", "geo": "Europa", "tier": "Deep Value", "desc": "Gruppo automotive tedesco (Porsche, Audi, VW) con forte scala industriale su piattaforme EV."},
    {"ticker": "ULVR.L", "name": "Unilever PLC", "emoji": "🧼", "sector": "Beni di Consumo Primari", "geo": "Europa", "tier": "Core Defensive", "desc": "Portafoglio di 400+ brand di largo consumo presenti nelle case di oltre 3.4 miliardi di persone."},

    # ── Asia & Emerging Markets ───────────────────────────────────────────────
    {"ticker": "1211.HK", "name": "BYD Co Ltd", "emoji": "🔋", "sector": "Veicoli Elettrici & Batterie", "geo": "Asia", "tier": "EV Global Leader", "desc": "Leader mondiale nella produzione di auto elettriche, ibride plug-in e tecnologia blade battery."},
    {"ticker": "1919.HK", "name": "COSCO SHIPPING Holdings", "emoji": "🚢", "sector": "Logistica & Spedizioni Marittime", "geo": "Asia", "tier": "Cyclical / High Yield", "desc": "Uno dei più grandi operatori mondiali di navi portacontainer e terminal portuali strategici."},
    {"ticker": "2318.HK", "name": "Ping An Insurance Group", "emoji": "🏦", "sector": "Assicurazioni & Finanza Digitale", "geo": "Asia", "tier": "Asia Value", "desc": "Il colosso finanziario e assicurativo più tecnologicamente avanzato della Cina."},
    {"ticker": "VOF.L", "name": "VinaCapital Vietnam Fund", "emoji": "🇻🇳", "sector": "Mercati di Frontiera Vietnam", "geo": "Asia / Frontiera", "tier": "High Growth Explorer", "desc": "Fondo specializzato sulle migliori aziende quotate e private equity del Vietnam in forte espansione."},
    {"ticker": "INDO.PA", "name": "Amundi MSCI Indonesia ETF", "emoji": "🇮🇩", "sector": "ETF Mercati Emergenti", "geo": "Asia / Emergenti", "tier": "Emerging Market", "desc": "Esposizione all'economia dell'Indonesia, ricca di nickel e trainata da un boom demografico."},

    # ── Strategic ETFs, Metals & Cash Reserves ────────────────────────────────
    {"ticker": "PPFB.DE", "name": "iShares Physical Gold ETC", "emoji": "🥇", "sector": "Oro Fisico & Beni Rifugio", "geo": "Globale", "tier": "Safe Haven Hedge", "desc": "Copertura contro l'inflazione e tensioni geopolitiche garantita da oro fisico custodito a Londra."},
    {"ticker": "SX7PEX.DE", "name": "iShares STOXX Europe 600 Banks", "emoji": "🏛️", "sector": "Banche Europee ETF", "geo": "Europa", "tier": "Value & High Yield", "desc": "Paniere dei principali istituti bancari europei con solidi margini di interesse e dividendi generosi."},
    {"ticker": "IEUR", "name": "iShares Core MSCI Europe ETF", "emoji": "🇪🇺", "sector": "Azionario Europeo Broad", "geo": "Europa", "tier": "Core Diversifier", "desc": "Esposizione ampia e a basso costo alle migliori 400+ aziende del continente europeo."},
    {"ticker": "IQQL.DE", "name": "iShares Listed Private Equity", "emoji": "🔥", "sector": "Private Equity Quotato", "geo": "Globale", "tier": "Alternative Asset", "desc": "Investimento nelle società di private equity e buyout globali (Blackstone, KKR, Carlyle)."},
    {"ticker": "IB01.L", "name": "iShares $ Treasury 0-1yr ETF", "emoji": "💵", "sector": "Treasury USA a Breve Termine", "geo": "USA", "tier": "Liquidità & Resa USD", "desc": "Titoli di Stato USA a brevissima scadenza per rendimento monetario privo di rischio e riserva per crolli."},
    {"ticker": "XEON.DE", "name": "Xtrackers EUR Overnight Rate Swap", "emoji": "💤", "sector": "Liquidità Overnight EUR (€STR)", "geo": "Europa", "tier": "Liquidità EUR", "desc": "Rendimento monetario overnight garantito sul tasso interbancario BCE per la quota in Euro."},
    {"ticker": "WDEF.L", "name": "WisdomTree Europe Equity Income", "emoji": "💼", "sector": "ETF Dividendi Europei", "geo": "Europa", "tier": "High Dividend ETF", "desc": "Selezione di titoli europei ad alta resa e sostenibilità del dividendo nel tempo."},

    # ── Private / Space & Crypto Assets ───────────────────────────────────────
    {"ticker": "SPCX.RTH", "name": "Space Exploration Tech (SpaceX)", "emoji": "🚀", "sector": "Spazio, Satelliti & Starlink", "geo": "USA", "tier": "Pre-IPO Moat", "desc": "Dominatore globale del lancio spaziale orbitale e costellazione Starlink a crescita esponenziale."},
    {"ticker": "ETOR", "name": "eToro Group Ltd", "emoji": "🏛️", "sector": "Social Investing Platform", "geo": "Globale", "tier": "Fintech Ecosystem", "desc": "Piattaforma pioniera del social trading e del copy trading con milioni di utenti attivi nel mondo."},
    {"ticker": "TRX", "name": "TRON Network", "emoji": "🪙", "sector": "Crypto · Stablecoin Rail", "geo": "Globale", "tier": "Digital Assets", "desc": "Network blockchain leader assoluto nel volume globale di trasferimenti in stablecoin (USDT)."},
]
...
<head>
  ...
  <title>Andrea Ravalli · Portfolio Hub & Popular Investor Insights</title>
  <meta name="description" content="Hub ufficiale del portafoglio eToro di Andrea Ravalli: rendimenti storici (+200% dal 2020), asset allocation globale, esploratore posizioni e guida per i copiatori.">
  ...
  <style>
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .hero-top {{ max-width: 820px; margin-bottom: 28px; }}
    ...
    /* ── Section Blocks ───────────────────────────────────────────────────── */
    .section-title {{
      font-size: 1.5rem; font-weight: 900; letter-spacing: -0.02em; margin-bottom: 20px;
    ...
    .bench-diff.red {{ color: var(--red); text-shadow: none; }}
    ...
    /* ── Asset Allocation Dual Doughnuts ─────────────────────────────────── */
    .allocation-grid {{
      display: grid; grid-template-columns: 1fr; gap: 20px; margin-bottom: 36px;
    }}
    @media(min-width: 860px) {{ .allocation-grid {{ grid-template-columns: 1fr 1fr; }} }}
    .alloc-card {{
      background: var(--surface); border: 1px solid var(--surface-border);
      border-radius: var(--radius-lg); padding: 24px; box-shadow: var(--shadow);
    }}
    .alloc-card h3 {{ font-size: 1.15rem; font-weight: 800; margin-bottom: 16px; display: flex; align-items: center; gap: 8px; }}
...
<body>
  ...
  <main class="container">
    ...
    <div id="tab-investor" class="tab-content active">
      ...
      <section>
        <div class="section-title">
          <span>🥧 Asset Allocation & Diversificazione</span>
      ...
      <section class="holdings-container">
        <div class="section-title">
          <span>🔍 Esploratore Titoli del Portafoglio</span>
          <span class="tag">41 Posizioni Attive</span>
        </div>

        <div class="holdings-filter-bar">
          <input type="text" id="holdingSearch" class="search-input" placeholder="Cerca ticker, azienda o settore..." oninput="filterHoldings()">
  ...
  <script>
    ...
    // Check URL query param ?mode=admin
    ...
    const arAnnual = [56.4, 33.1, -14.2, 38.6, 28.9, 22.4, 12.8];
    ...
    function renderPerfChart(mode = 'annual') {{
      ...
      if (mode === 'annual') {{
        ...
        // Cumulative growth of 10k
        const arCum = [10000, 15640, 20816, 17859, 24752, 31905, 39051, 44050];
    ...
    // ── Holdings Explorer Grid ─────────────────────────────────────────────
    let activeFilter = 'ALL';

    function renderHoldingsGrid(items) {{
      const container = document.getElementById('holdingsGrid');
      container.innerHTML = '';

      if (items.length === 0) {{
        container.innerHTML = '<p style="grid-column: 1/-1; text-align: center; color: var(--muted); padding: 40px;">Nessun titolo trovato con i criteri selezionati.</p>';
        return;
      }}
    ...
    window.addEventListener('DOMContentLoaded', () => {{
      ...
      renderHoldingsGrid(holdingsData);
    }});
  </script>
</body>
</html>
